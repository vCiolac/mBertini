      ...
      >
        ...
        >
          {topics.map((topic, index) => (
            <div
              key={index}
              className="w-full max-w-[600px] bg-white text-black mb-4 cursor-pointer rounded-lg shadow-md event-box"
        ...
        <section className="absolute bottom-0 h-[100vh] lg:h-[160vh] w-full bg-gray-200 flex items-center justify-center">
          <AdditionalContent />
        </section>
      </section>
    </>
